...
bool MainManager::firstMouse;
float MainManager::lastX;
float MainManager::lastY;
Camera* MainManager::camera;
...
MainManager mainManager(800, 600, &mainCamera);
...
void Rendering() {
    ...
    glm::mat4 projection;
    projection = glm::perspective(glm::radians(mainCamera.Zoom), 800.0f / 600.0f, 0.1f, 100.0f);
